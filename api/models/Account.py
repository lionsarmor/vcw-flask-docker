...
class Account(Mixin, db.Model):
    ...
    def __repr__(self):
        return f"<Account {self.name, self.id, self.channel_number, self.call_sign, self.full_name, self.source_id, self.hgtv. self.load_date}>"
